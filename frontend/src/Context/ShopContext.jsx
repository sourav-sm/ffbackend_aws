...
const ShopContextProvider = (props) =>{
        ...
        useEffect(()=>{
             ...
             fetch('https://ff-backend-xsw5.onrender.com/allproducts')
            ...
            if(localStorage.getItem('auth-token')){
               //fetch('http://localhost:4000/getcart',{
                //fetch('https://fftrail.onrender.com/getcart',{
                    fetch('https://ff-backend-xsw5.onrender.com/getcart',{
                    method:'POST',
                    headers:{
        ...
        const addToCart=(itemId)=>{
            ...
            if(localStorage.getItem('auth-token')){
                ...
                fetch('https://ff-backend-xsw5.onrender.com/addtocart',{
                    method:'POST',
                    headers:{
                        Accept:'application/form-data',
                        'auth-token':`${localStorage.getItem('auth-token')}`,
        ...
        const removeFromCart=(itemId)=>{
            ...
            if(localStorage.getItem('auth-token')){
                ...
                fetch('https://ff-backend-xsw5.onrender.com/removefromcart',{
                    method:'POST',
                    headers:{
                        Accept:'application/form-data',
                        'auth-token':`${localStorage.getItem('auth-token')}`,
            ...
            const makePayment = token=>{
              ...
              const headers={
               ...
               //return fetch(`http://localhost:4000/payment`,{
                ...
                return fetch(`https://ff-backend-xsw5.onrender.com/payment`,{
                method:"POST",
                headers,
